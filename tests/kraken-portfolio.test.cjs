...
test('renderer uses text only and marks unpriced positions',()=>{
 ...
 try{renderKrakenPortfolio({total_value_usd:null,known_value_usd:3,complete:false,unpriced_assets:['<bad>'],as_of:'2026-09-01T00:00:00Z',hidden_small_positions:0,positions:[{asset:'<img>',balance:2,price_usd:null,value_usd:null,price_pair:null,status:'unpriced'}]});
